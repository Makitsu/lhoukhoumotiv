...
_STOP_CITY = ['Vannes', 'Auray', 'Lorient', 'Vitré', 'Quimper', 'Quimperlé', 'Rosporden', 'Saint-Malo',
              'Dol-de-Bretagne', 'La Roche-sur-Yon', 'Saint-Nazaire', 'La Baule-Escoublac', 'Le Croisic', 'Pornichet',
              'Le Pouliguen', 'Sablé-sur-Sarthe', "Les Sables-d'Olonne", 'Biganos', 'Arcachon', 'La Teste-de-Buch',
              'Libourne', 'Vendôme', 'Châtellerault', 'Dax', 'Bayonne', 'Biarritz', 'Saint-Jean-de-Luz', 'Hendaye',
              'Niort', 'Surgères', 'La Rochelle', "Saint-Maixent-l'École", 'Chasseneuil-du-Poitou', 'Tours', 'Orthez',
              'Pau', 'Lourdes', 'Tarbes']
